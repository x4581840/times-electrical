...
public interface ISceneFaultLabelService {
    //根据故障编码，在现场事件表中查出详情
    List<SceneFaultLabel> getOneTabResult(String fGzpthwzbm, String startTime, String endTime);
   //弹出框模糊查询
    List<SceneFaultLabel> getTwoTabResult(String fGzpthwzbm);
   //超链接查询
   List<copySceneFaultLabel> getLinkREsult(String fGzpthwzbm, String fGzpmc, String fCxdl, String fZccx, String fZyzrdw );
